                    ...
                    return (
                        <div className="accordion-item " key={item.number}>
                            <h2 className="accordion-header" id={`flush-heading${item.number}`}>
                                <div className="accordion-button collapsed fs-6 fs-md-5  bg-transparent text-dark cursor" data-bs-toggle="collapse" data-bs-target={`#flush-collapse${item.number}`} aria-expanded="false" aria-controls={`flush-collapse${item.number}`}>
