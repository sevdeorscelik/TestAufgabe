    ...
    return (
        <div className="d-flex flex-column justify-content-center ">
            ...
            <div className="align-self-center">
                <button type="button" class="btn text-white p-2 pe-5 ps-5 fw-bold bg-red" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">E-MAIL-ADRESSE ÄNDERN</button>
                <Popup />
            </div>
            <i className="fas fa-angle-up align-self-center mt-5 fs-5 color-red"></i>
        </div >
    )
};
