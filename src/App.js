  ...
  return (
    <div className="App">
      <header className='position-relative d-flex justify-content-center mb-5'>
        <img className='' src='/img/Header.png' alt='header'></img>
        ...
        <div className='position-absolute d-flex flex-column justify-content-center align-items-center user-container'>
          ...
          <div className='position-relative '>
            ...
            <i className="fas fa-pen position-absolute end-0 rounded-circle p-2 text-light fs-6 pen-icon"></i>

          </div>

          <p className='fs-4 fw-bolder color-blue'>devel oper</p>
